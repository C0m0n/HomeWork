...
public class ATMApp extends Application {
    ...
    private Map<PageName, Pane> pages = Map.of(PageName.LOGIN, new LoginPage(eagleBank), PageName.CREATE, new Create(eagleBank), PageName.MAINPAGE, new MainPage(eagleBank), PageName.TRANSFER, new Transfer(eagleBank));
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        menuClose.setOnAction((e) -> primaryStage.close());
        primaryStage.show();
