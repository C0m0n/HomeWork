...
public class ATMApp extends Application {
    ...
    EagleBank eagleBank = new EagleBank();
    
    
    //Use map to map pages to the names

    
    private Map<PageName, Pane> pages = Map.of(PageName.LOGIN, new LoginPage(eagleBank), PageName.CREATE, new Create(eagleBank), PageName.MAINPAGE, new MainPage(eagleBank), PageName.TRANSFER, new Transfer(eagleBank), PageName.CHANGEPIN, new ChangePin(eagleBank));
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        //Event handelers for the menu items
        menuClose.setOnAction((e) ->{
            try {
                eagleBank.printReceipt();
        ...
        menuLogOut.setOnAction((e) -> selectPage(PageName.LOGIN));
        menuCreateNew.setOnAction((e) -> selectPage(PageName.CREATE));
        menuChangePin.setOnAction((e) -> selectPage(PageName.CHANGEPIN));
        primaryStage.show();
    ...
    private void selectPage(PageName pageName){
