...
public class LayoutsDemo extends Application {
	...
	public void initLayoutsDemo() {
		...
		tileBt4.setStyle("-fx-background-color:#FF0000");

		Font comicSans = new Font("Comic Sans MS", 16);
		flowBt2.setFont(comicSans);
		...
		Circle circle1 = new Circle(100, 200, 20, Color.RED);
		Line line1 = new Line(0, 0, 100, 200);
		Rectangle rect1 = new Rectangle(50, 50, 20, 30);
		...
		flowPaneChildren.add(circle1);
		flowPaneChildren.add(line1);
		flowPaneChildren.add(rect1);
